...
var moveIfExistsFromBuildToStatic = function (fileToCopy) {
    var from = path.resolve(__dirname, "../build/" + fileToCopy);
    console.log('from: ', from);
    if (fs.existsSync(from)) {
        console.log('      exists.');
        fs.renameSync(from, path.resolve(__dirname, "../build/static/" + fileToCopy));
    }
};
