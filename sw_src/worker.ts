// @ts-ignore
import { DocProcesoInfo, DownloadBytesMessage, DownloadConcluded, JanelinhaEvent, JanelinhaProcessoInfo, WSEventInfo } from "../src/app_functions/WSEventInfo_interfaces";
